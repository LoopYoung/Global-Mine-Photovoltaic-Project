...
#install cost
install_cost = pd.read_excel("installlation_cost_data", sheet_name='Install')
#minepv data
base = pd.read_excel("mpv_data", sheet_name='base')
#OECD country list
OECD_list = pd.read_excel("OECD_country_list", sheet_name='OECD_list')
#WACC for different countries
WACC = pd.read_excel("WACC_data", sheet_name='WACC')
...
# calculate the solar altitude and azimuth at 3:00PM at winter solstice
